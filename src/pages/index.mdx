...
<HomepageLayout>
	...
	A year ago I quit my job to explore some projects of my own. In the past, I've worked at [Neuralink](https://neuralink.com/), [Hack Club](https://hackclub.com/), [Replit](https://replit.com/), and [Redwood Research](https://www.redwoodresearch.org/). I am a fellow of [Lux](https://www.luxcapital.com/), [Human Capital](https://human.capital/), and [Interact](https://joininteract.com/).
	...
	A consistent thread through the past couple of years of my life has been meeting my online programmer friends in person. I'm lucky enough that many friends I previously only know online now live within a few blocks of me. This chapter of my life began in the summer of 2021 when I rode across the country on a hackathon on a [superdome train](https://en.wikipedia.org/wiki/Super_Dome_(railcar)), and since then, I've met friends as far as Europe and as exotically as Kalamazoo (a real place in Michigan!).
	...
	I started training for my Private Pilot License, first out of [KSSF](https://en.wikipedia.org/wiki/Stinson_Municipal_Airport), then [KBTV](https://en.wikipedia.org/wiki/Patrick_Leahy_Burlington_International_Airport), and now [KSQL](https://en.wikipedia.org/wiki/San_Carlos_Airport_(California)). I keep getting peskily interrupted, but I've finally un-interrupted myself and I want to finish my license this year.
	...
	I compose music for acoustic instruments and create electronic bleep bloop sounds in a variety of styles using [Ableton](https://www.ableton.com/en/live/), [REAPER](https://www.reaper.fm/), [Pd](https://puredata.info/), and [Max](https://cycling74.com/products/max/). Perhaps I'll release an album eventually.
	...
	- [Aims by Vienna Teng](https://open.spotify.com/intl-de/album/4Ezl6L07JRUsUseRzWFywp?si=mVCTWIbcRNqqvZJZl4sWvQ) (experimental-ish floaty poppy vocal music, perhaps the best album ever made)
	- [Nurture by Porter Robinson](https://album.link/us/i/1550626757) (electronic bliss)
	- [molecule by torr](https://album.link/s/1sZhAMSxyVfitDVgv0xFuX) (poppy hyperpop, or hyperpoppy pop)
	- [Escaper by Sarah Kinsley](https://album.link/s/1DKZiCIxfbZB5I1p7JhXym) (pop; I crashed on my bike while listening to it and yet I still love it)
	...
	- [Some songs that I think go together](https://open.spotify.com/playlist/2QmZKRwfy8FdBhaHfypfiG?si=cf889fce41a741a1)
	...
	- [Orchestraslop](https://open.spotify.com/playlist/0dWtMu6TSwoMlpU9oQKg1D?si=35a5a82bde8c413c)

	I also used to [play Beat Saber badly](https://scoresaber.com/u/4470475412964296) and loved it, although I haven't had that much time recently. (For some reason, I was unusually good at one-handed mode. I could destroy even some top ranked players.) I DJ sometimes, but I wouldn't call myself an expert. I enjoy jarring transitions.
	...
	Live-action movies that stuck out to me as really great are [Dr. Strangelove](https://www.imdb.com/title/tt0057012/), [tick, tick... BOOM!](https://www.imdb.com/title/tt8721424/), [The Secret Life of Walter Mitty](https://www.imdb.com/title/tt0359950/), [Eternal Sunshine of the Spotless Mind](https://www.imdb.com/title/tt0338013/), [Resurrection](https://www.imdb.com/title/tt29002950/), [Wake Up Dead Man](https://www.imdb.com/title/tt14364480/), and [Black Bag](https://www.imdb.com/title/tt30988739/).
	...
	<div class='grid-twos' role='list'>
		<BookCard
			...
			url='https://www.amazon.com/Daytripper-Gabriel-Ba/dp/1401229697/'
			cover='/book-covers/daytripper.jpg'
			coverWidth='288'
			coverHeight='445'
		/>
		<BookCard
		...
		<BookCard
			...
			author='Rachel Aviv'
			url='https://www.amazon.com/Strangers-Ourselves-Unsettled-Minds-Stories/dp/0374600848'
			cover='/book-covers/strangers-to-ourselves.jpg'
			coverWidth='400'
			coverHeight='618'
		/>
		<BookCard
	...
	- **[Freak in the Sheets](https://devpost.com/software/freak-in-the-sheets-7jl542):** LLVM backend that compiles to Google Sheets. Dual winner of TreeHacks 2026.
	- **[jetch](https://jetch.kognise.dev/):** A silly drawing app with very peak advertisements that I made spontaneously for [jia](https://www.jia.build/) because she asked me to on Twitter.
	- **[Tauri Chipmunk](https://github.com/kognise/tauri-chipmunk):** A modern GitHub Releases update server for Tauri apps.
	- **[jsbee](https://jsb.ee/) and [pybee](https://pyb.ee/):** A game where you have to write a function with someone else, one letter at a time and with no deletions.
	- **[koggerboxd](https://tv.kognise.dev/):** I'm watching a lot of movies in theaters this year and I'm tracking them all.
	- **Cosmere:** A really good \*\*\*\*\*\*\* downloader. Not public because I don't really want to get DMCAed.
	...
	- **Neuralink Patient Portal:** What it says on the tin. Built Neuralink's patient intake website and a lot of really nice internal tooling.
	...
	- **kogdb:** A many-gigabyte database of every message I've ever sent or received on any chat platform.
	...
	- **ZNY PRD+ and ZNY delivery helper:** Various tools to help me control airports on VATSIM.
	...
	<img src='/photos/me-footer.jpg' alt='A white person with a brown ponytail grinning, sitting on a gray bed in front of a wall of posters.' width='1000' height='748' loading='lazy' style='width: min(500px, 100%); margin-top: 60px;' />

	^ Finally, here&rsquo;s me in my room, taken on my E-M10 Mk.II!
