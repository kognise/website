...
<HomepageLayout>
	...
	Hello! I usually go by the moniker Kognise <span role='button' id='ipa'>/ˈkägˌnaɪz/</span> on the internet. Many things capture my interest, and this website features some of them. You may find [the occasional article](/writing/) interesting.

	Reach out: [hi@kognise.dev](mailto:hi@kognise.dev) or Kognise#6356 on Discord
	...
	I currently work at [Hack Club](https://hackclub.com/). In the past, I've worked with [Replit](https://replit.com/) and [Redwood Research](https://www.redwoodresearch.org/).
	...
	I spend a significant portion of my time writing code and creating with technology, and run a community of really awesome programmers which [you should totally join](https://pensquid.net/). I love building things, and as a result have a huge amount of side projects that I don't really know what to do with. You can [see an abridged list of stuff I've done](#projects) if you're interested.

	I use TypeScript, Rust, and Next.js on a daily basis and love them. I used to daily drive NixOS with KDE Plasma (you can [check out my dotfiles](https://github.com/kognise/dotfiles/), they're not half bad) but now just use macOS and reserve NixOS for my desktop at home. I design everything for myself, and sometimes for others, using Figma.

	In the summer of 2021 I rode across the country with a bunch of other cool programmers on a literal freaking [superdome train](https://en.wikipedia.org/wiki/Super_Dome_(railcar)), and that was pretty cool. Recently, I've been traveling a lot to meet friends all over, including to famed Kalamazoo!
	...
	<div class='grid-twos'>
		...
		<BookCard
			...
			url='https://www.amazon.com/Diamond-Age-Illustrated-Primer-Spectra/dp/0553380966/'
	...
	Feel free to shoot me an email or message anytime and for whatever reason!
	...
	- **[???](https://stablequarters.org/):** ?̵̹̮͓́̄¿̸̹̝͚͕̪̂̓̈̒͊͠ͅ¿̵̤̪̻̀̍̋̈͠?̸̢̫͉̻̲́̈̑̕͝_̶̟̙͍̩͙̲̎̈́̉͘?̷̹̘͕̤͈̗͐̅͝¿̵̰̓͋͆͑̄́͘¿̴̯͉͕͍̣̅͠¿̸̧̼̫̩̯́͜͠?̷̮͕̐̈́͆¿̶̨̗͙̬̥̠̳̇͆̅͐¿̶̗͑̎.̸̢͚̜͈̑ͅͅ¿̷̨̝̮͗̾͂̅̂̚-̴̨̛̥̈́͐͑̈͐̂-̴̯͎̠͝¿̷̭̬͍̠̳̯͛̈͒¿̵̟͕̎͑̌̒?̸̰͐͐̿͌͘͘͝?̵̨͙͔͉̥̞̼͋-̸̜̺̙͚̋_̸̖̯͐͊͌̾͆́?̴̡̮̒̎?̸̧̛̞̻̤͉̠?̶͓̮͖̟̦̔̌́¿̵̡͓̺͉͓̇͑̈́́?̶̙̄͑̀̎̎̿͠?̵͇͔̫͓͖̯̌̀ͅ?̷̩̞͎̺̭͈́͌̐̋̂͠͠¿̸̣̩͔̬̲̏̿̃͝͝
